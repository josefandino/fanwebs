...
@section('page-header')
  Data ZIS <small>{{ trans('app.manage') }}</small>
@stop
...
<body>
  ...
  <div class="row">
    <div class="col-md-12">
            ...
            @endif
            <a href="{{ url('admin/zis/create') }}" class="fa fa-plus-circle fa-2x"></a><h3 align="center">DATA KAJIAN</h3>
            <hr>
